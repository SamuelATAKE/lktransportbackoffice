...
const NOTIFICATIONS = [
  {
    ...
    title: 'Votre commande est recue',
  ...
  },
  {
    ...
    description: 'Repondu a votre commentaire de facon minimale',
  ...
  {
    id: faker.datatype.uuid(),
    title: 'Vous avez un nouveau mail',
    description: 'Envoye par Guido Padberg',
    avatar: null,
    type: 'mail',
    ...
    <>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', py: 2, px: 2.5 }}>
          ...
          {totalUnRead > 0 && (
            <Tooltip title=" tout marqué comme lu">
